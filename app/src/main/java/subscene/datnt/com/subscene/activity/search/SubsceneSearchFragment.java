...
public class SubsceneSearchFragment extends Fragment implements OnItemClickListener, OnSceneListener {
    ...
    private void search() {
        ...
        subscene.getMovieSubsByName(query,"");
    }
